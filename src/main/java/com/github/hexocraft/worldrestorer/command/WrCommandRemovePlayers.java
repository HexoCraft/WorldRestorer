 ...
 */
public class WrCommandRemovePlayers extends Command<WorldRestorer>
{
	...
	public boolean onCommand(CommandInfo commandInfo)
	{
		...
		SimplePrefixedMessage titleMessage = new SimplePrefixedMessage(prefix, WorldRestorer.messages.sRemove.replace("{WORLD}",worldName), ChatColor.GREEN);
